    ...
    <footer style={{ background: 'var(--bg)', borderTop: '1px solid var(--line)' }}>
      <div className="container" style={{ paddingTop: '4rem', paddingBottom: '2rem' }}>
        ...
        <div className="grid-12" style={{ display: 'grid', gridTemplateColumns: 'repeat(12, 1fr)', gap: '2.5rem', paddingBottom: '3rem', borderBottom: '1px solid var(--line)', marginBottom: '1.5rem' }}>
          ...
          <div style={{ gridColumn: '1 / 5' }}>
            ...
            <div style={{ display: 'flex', gap: '0.5rem', flexWrap: 'wrap' }}>
              {[{ l: 'Instagram', h: 'https://www.instagram.com/astirmind/' }, { l: 'Twitter', h: 'https://twitter.com/AstirMind' }, { l: 'Facebook', h: 'https://www.facebook.com/AstirMind-363890014173446' }].map((s, i) => (
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '0.75rem' }}>
          ...
          <a href="mailto:astirmind@gmail.com" className="t-mono" style={{ fontSize: '0.5625rem', color: 'var(--text-3)', textDecoration: 'none', transition: 'color 0.15s' }}
            onMouseEnter={e => e.currentTarget.style.color = 'var(--text)'}
            onMouseLeave={e => e.currentTarget.style.color = 'var(--text-3)'}
          >astirmind@gmail.com</a>
        </div>
      </div>
    </footer>
  );
